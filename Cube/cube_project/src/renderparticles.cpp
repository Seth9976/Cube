...
void render_particles(float time)
{
    ...
    {
        { 0.7f, 0.6f, 0.3f, 2,  3, 0.3f }, // yellow: yellow sparks 
        { 0.2f, 0.2f, 0.1f, 20, 7, 0.2f }, // yellow:   small smoke
        { 0.2f, 0.2f, 1.0f, 20, 3, 0.08f }, // blue:   edit mode entities
        { 0.2f, 0.2f, 1.0f, 1,  7, 0.06f }, // blue:   blood spats
        { 1.0f, 0.8f, 1.0f, 20, 6, 1.2f  }, // blue:   fireball1
        { 1.0f, 0.1f, 0.1f, 20, 7, 0.6f  }, // red:   big smoke   
